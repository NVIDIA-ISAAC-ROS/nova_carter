...
#include "RMP220-SDK/comm_ctrl_navigation.h"
...
const std::vector<std::pair<std::string, std::string>> EXTENSIONS = {
  ...
  {"gxf_isaac_messages", "gxf/lib/libgxf_isaac_messages.so"},  // rangescan info
  {"gxf_isaac_segway", "gxf/lib/libgxf_isaac_segway.so"}
};
...
: nitros::NitrosNode(options,
  ...
  enable_odometry_tf_(declare_parameter<bool>("enable_odometry_tf", true)),

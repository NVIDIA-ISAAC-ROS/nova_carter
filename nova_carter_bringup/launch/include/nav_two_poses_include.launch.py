...
def set_override_parameters(args: lu.ArgumentContainer) -> list[Action]:
    ...
    if args.mode == 'simulation':
        ...
        print('Enabling nvblox local costmap.')
        local_costmap_plugins.append('nvblox_layer')
        print('Enabling map global costmap.')
...
def generate_launch_description() -> LaunchDescription:
    ...
    args.add_arg('vslam_image_qos', 'DEFAULT')
    ...
    navigation_parameters_path = args.navigation_parameters_path
